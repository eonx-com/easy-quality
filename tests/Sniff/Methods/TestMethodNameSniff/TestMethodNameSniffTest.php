...
namespace EonX\EasyQuality\Tests\Sniff\Methods\TestMethodNameSniff;
...
/**
 * @covers \EonX\EasyQuality\Sniff\Methods\TestMethodNameSniff
 *
 * @internal
 */
final class TestMethodNameSniffTest extends AbstractCheckerTestCase
{
    ...
    protected function getCheckerConfiguration(): array
    {
        return [
            'allowed' => [
                [
                    'namespace' => '/^EonX\\\EasyQuality\\\Tests\\\Sniff\\\Methods\\\TestMethodNameSniff\\\Fixtures\\\(Correct|Wrong)$/',
